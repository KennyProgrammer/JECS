...
import kenny.jecs.funcs.EachI.JECSApi;

/**
 * This functional interface implements the {@link kenny.jecs.JECS#destroy(DestroyI)} 
 ...
 */
@FunctionalInterface
public interface DestroyI 
{
	/**
	 * This method implements the {@link kenny.jecs.JECS#destroy(int, DestroyI)}. Its allows
