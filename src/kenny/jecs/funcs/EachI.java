...
/**
 * This functional interface implements the {@link kenny.jecs.JECS#each(Class, EachI)} 
 ...
 */
@FunctionalInterface
@EachI.JECSApi(since = "0.1.5")
public interface EachI<Component>
{
	/**
	...
	/**
	 * This method implements the {@link kenny.jecs.JECS#each(Class, EachI)}. Its allows
