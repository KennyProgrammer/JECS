...
/**
 * This functional interface implements the {@link kenny.jecs.BaseJECS#each(Class, IEachC)} 
 ...
 */
@FunctionalInterface
@IEachC.JECSApi(since = "0.1.5")
public interface IEachC<EntityT, Component>
{
	/**
	...
	/**
	 * This method implements the {@link kenny.jecs.BaseJECS#each(Class, IEachC)}. Its allows
	 ...
	 * 
	 * <p>
	 * Difference between this {@link IEachC} and normal {@link IEach} is:
	 * <p>
	 * - This {@link IEachC} function is for all component types, i.e for all
	 * {@link Object}s. And to get access to its methods/functions it should be cast
	 * to specific component the which you want.
	 * <p>
	 * - But normal {@link IEach} function uses for one type of component and all it
